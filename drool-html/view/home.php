      ...
      <div class="col-lg-8 col-12 mx-auto">
        ...
        <form action="timkiem.php" method="post" class="custom-form mt-4 pt-2 mb-lg-0 mb-5" role="search">
          <div class="input-group input-group-lg">
            ...
            <button name="search_button" type="submit" class="form-control"><div style="margin-top:-4px">Search</div></button>
          </div>
        </form>
      </div>
    ...
    <div class="food_container">
      <div class="box">
        ...
        <div class="detail-box">
          ...
          <a style="color:white" href=""> Mua Ngay
          </a>
        </div>
      </div>
      <div class="box">
        ...
        <div class="carousel-item active">
          <div class="box">
            ...
            <div class="detail-box">
              ...
              <p>
              Shop rất tận tình tư vấn khách hàng, mình đã mua được chú cún rất dễ thương mà khi tính tiền vẫn còn hơi lu bu chắc do shop mới khai trương mong shop sẽ tối ưu
              </p>
